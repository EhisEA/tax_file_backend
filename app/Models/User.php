 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\TaxFiling> $tax_filings
 * @property-read int|null $tax_filings_count
...
class User extends Authenticatable
{
    ...
    /**
     * @return MorphTo<UserProfile|AccountantProfile,User>
     */
